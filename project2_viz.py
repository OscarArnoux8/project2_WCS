...
with col1:
    st.button('')
    st.markdown(f'''
    <a target="_self" href="https://share.streamlit.io/oscararnoux8/project2_wcs/main/projet2_app.py" style="text-decoration: none; color:white">
...
col1, col2, col3 = st.columns([1,5,1]) # Center our image
with col1:
  st.write("")
with col2:
  st.image('clapperboard-g14403e813_640.png',width=350)
with col3:
  st.write("")

st.markdown("<h1 style='text-align: center;'>JAO Data : Analyse et Conseil</h1>", unsafe_allow_html=True)
st.markdown("<h1 style='text-align: center;font-size:30px;'>Julien Reppert, Alexis Le Bihan, Oscar Arnoux</h1>", unsafe_allow_html=True)
